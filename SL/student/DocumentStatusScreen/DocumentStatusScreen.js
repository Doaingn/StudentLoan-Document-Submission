        ...
        { text: "ยกเลิก", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              // ลบไฟล์ใน Storage
              const uploadsField = `uploads_${appConfig.academicYear}_${appConfig.term}`
              if (submissionData[uploadsField]) {
                for (const [docId, files] of Object.entries(submissionData[uploadsField] || submissionData.uploads)) {
